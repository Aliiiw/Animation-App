package com.alirahimi.borutoapp.data.remote


import com.alirahimi.borutoapp.domain.model.ApiResponse
import com.alirahimi.borutoapp.domain.model.Hero
import java.io.IOException

class FakeApi2 : BorutoApi {
    ...
    override suspend fun getAllHeroes(page: Int): ApiResponse {
        ...
        return ApiResponse(
            success = true,
            message = "ok",
            previousPage = calculate(page = page)["previousPage"],
